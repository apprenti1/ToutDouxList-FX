...
public class MineTypes {
    ...
    @FXML void edit(ActionEvent event) {Main.changeScene("EditType", new EditType(this.utilisateur, this.table.getSelectionModel().getSelectedItem()), "Modifie ton type :)");}
    @FXML void switchAddType(ActionEvent event) {Main.changeScene("EditType", new EditType(this.utilisateur), "Modifie ton type :)");}
